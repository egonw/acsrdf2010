...
is not obvious. Data types like connection tables and various matrices,
is possible, but the use of URIs makes such structures needlessly verbose.
...
ontologies take care of meaning, it does not enfore any data quality,
data structure, or data availability. This is, in fact, similar to other
